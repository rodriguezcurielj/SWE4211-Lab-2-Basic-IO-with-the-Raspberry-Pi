...
#define RT_SCHEDULER_TO_USE (SCHED_FIFO)
...
protected:
	...
	/**
	 * This attribute is the executing thread.  It is set when the thread is started and then is cached afterwards.
	 */
...
public:
	 ...
	 * @param priority This is the priority for the task.  By default, will be 0 unless another priority is passed into the constructor.
	 */
	RunnableClass(std::string threadName, int priority=0);
...
protected:
	...
	virtual void stopChildRunnables();
